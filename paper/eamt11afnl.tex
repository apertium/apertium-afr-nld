...
\begin{table}
  ...
  \begin{tabular}{|l|r|r|}
   ...
   \hline
   {\tt nl} Wikipedia     & 18,569,183      & 80.5\% $\pm$  \\
   \hline
  \end{tabular}
...
1,000 pseudo-randomly.\footnote{Using the Unix {\small {\tt unsort}} program.}
...
may lead to a correct translation.
...
system we undertook a qualitative evaluation by reviewing the translation errors and 
categorising them as in Table~\ref{table:qual}. An example of each of the kind of error
is found below.
