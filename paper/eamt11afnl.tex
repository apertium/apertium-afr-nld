...
\ex. \label{ex:exother1}
    ...
    In principe kan jij aan Wikipedia *meewerk zonder om enig *besprekingsblaaie te lezen. \\
...
\ex. \label{ex:exother2}
    ...
    *Morrison trekken naar Parijs met de plan om te concentreren op zijn *skryfwerk. \\
    Morrison trekt naar Parijs met het plan om zich te concentreren op zijn schrijfwerk. \\
