...
KDE4\footnote{\url{http://opus.lingfil.uu.se/KDE4v2.php}}, which is translated via English. We 
...
\begin{table}
  ...
  \end{tabular}
    \caption{Accuracy for the two test corpora as measured by Word Error Rate 
        and Position-independent Word Error Rate with confidence intervals
        at 95\% confidence.}
    \label{table:quan}
  \end{center}
\end{table}
