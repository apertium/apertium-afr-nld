...
morphological transducer for Afrikaans created during a separate, currently dormant, 
project on English--Afrikaans machine translation. Some changes were made. The structure 
of verb entries was wholly revised, and infrequent words, and words for which a translation
...
resampling \cite{Efron:94} method as described by \newcite{Koehn:04}.
...
Another issue are relative pronouns. The Afrikaans language uses the word {\em wat}, where the
...
\ex. \label{ex:exother1}
    ...
    `In principle you can work on Wikipedia without reading any talk pages.'
...
\bibitem[\protect\citename{Efron and Tibshirani}1994]{Efron:94}
