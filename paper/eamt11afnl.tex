...
Afrikaans \emph{ruk ... hand uit} corresponds with the Dutch seperable verb (and 
expression) \emph{loopt ... uit de hand} However, \emph{ruk} `to pull' in itself 
could never be translated as \emph{lopen} `to walk'. 
